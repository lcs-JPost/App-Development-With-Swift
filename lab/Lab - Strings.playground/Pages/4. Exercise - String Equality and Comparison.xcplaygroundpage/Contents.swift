...
if name == nameInCaps.lowercased() {
    print("Justus Post and justus post are the same.")
} else {
    print("Justus Post and justus post are not the same")
}
/*:
...
if junior.hasSuffix("Jr.") {
    ...
    print("We didn't find a second generation name!")
}
